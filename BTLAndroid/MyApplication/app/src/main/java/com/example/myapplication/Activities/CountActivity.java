...
import com.example.myapplication.chucnangDB.ChiTietDonDat;
...
public class CountActivity extends AppCompatActivity {
    ...
    int maban, mamon;
    DonDatDB donDatDB;
    ChiTietDonDat chiTietDonDatDAO;
...
//Lấy đối tượng view
        ...
        chiTietDonDatDAO = new ChiTietDonDat(this);
        ...
        BTN_amountmenu_DongY.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int madondat = (int) donDatDB.LayMaDonTheoMaBan(maban,"false");
                ...
                if(ktra){
                    ...
                    ChiTietDonDatDTS chiTietDonDatDTO = new ChiTietDonDatDTS();
